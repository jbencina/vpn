...
read -p "Client IP Last Octet (eg. 10.0.0.x): " CLIENT_IP
...
Address = 10.0.0.${CLIENT_IP}/32, fd86:ea04:1111::${CLIENT_IP}/128
DNS = 10.0.0.1
...
PresharedKey = $(cat "keys/${CLIENT_NAME}_psk")
AllowedIPs = 10.0.0.${CLIENT_IP}/32, fd86:ea04:1111::${CLIENT_IP}/128" > "configs/${CLIENT_NAME}_peer.conf"
